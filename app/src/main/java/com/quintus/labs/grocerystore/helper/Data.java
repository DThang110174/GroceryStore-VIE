...
public class Data {
    ...
    public List<Category> getCategoryList() {
        Category category = new Category("1", "Giai đoạn 1", "img/international_1.png");
        categoryList.add(category);
        category = new Category("2", "Giai đoạn 2", "https://lisasnatural.com/wp-content/uploads/2018/05/housecleanicon-300x228.jpg");
        categoryList.add(category);
    ...
    public List<Product> getPopularList() {
        ...
        product = new Product("7", "4", "Apple", "", "1 Kg", "Rs.", "20", "", "https://bizweb.dktcdn.net/100/115/768/articles/dinh-gia-tien-co-viet-nam-bang-cach-nao.jpg?v=1614262204277");
        popularList.add(product);
        product = new Product("8", "4", "Apple", "", "1 Kg", "Rs.", "20", "", "https://storage.googleapis.com/zopnow-static/images/products/320/fresh-apple-red-delicious-v-500-g.png");
        popularList.add(product);
        product = new Product("9", "5", "Apple", "", "1 Kg", "Rs.", "20", "", "https://storage.googleapis.com/zopnow-static/images/products/320/fresh-apple-red-delicious-v-500-g.png");
